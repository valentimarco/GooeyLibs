...
import ca.landonjw.gooeylibs2.fabric.cookbook.shooter.enemies.LargeAsteroid;
import ca.landonjw.gooeylibs2.fabric.cookbook.shooter.enemies.MediumAsteroid;
import ca.landonjw.gooeylibs2.fabric.cookbook.shooter.enemies.SmallAsteroid;
...
public class ShooterController extends UpdateEmitter<ShooterController>
{
    ...
    private ShooterEnemy getRandomEnemy(int col) {
        return switch (random.nextInt(3))
                {
                    case 0 -> new SmallAsteroid(col);
                    case 1 -> new MediumAsteroid(col);
                    case 2 -> new LargeAsteroid(col);
                    default -> null;
                };
    }
